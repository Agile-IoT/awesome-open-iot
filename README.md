...
| [Zilla](https://github.com/aklivity/zilla)  <br> [![GitHub stars](https://img.shields.io/github/stars/aklivity/zilla.svg?style=social&label=Star&maxAge=2592000)]()     | A Multi-protocol event-native edge/service proxy that supports standard protocols such as HTTP, SSE, gRPC, MQTT and the native Kafka protocol. | ASLv2 | Java               |

...
|                                                                                Name                                                                               |                                              Description                                              | License |                          Language                          |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------|---------|------------------------------------------------------------|
| [Eclipse Paho](https://eclipse.org/link)                                                                                                                          | The Eclipse Paho project provides open-source client implementations of MQTT                          | EPL/EDL | Java, Python, Javascript, Go, C, .Net (C#), Embedded C/C++ |
| [Moquette](https://github.com/andsel/moquette)                                                                                                                          | MQTT broker 100% open source  | Apache 2.0 | Java |
| [MQTT.js](https://github.com/mqttjs/MQTT.js) <br> [![GitHub stars](https://img.shields.io/github/stars/mqttjs/MQTT.svg?style=social&label=Star&maxAge=2592000)]() | MQTT.js is a client library for the MQTT protocol, written in JavaScript for node.js and the browser. | MIT     | Javascript                                                 |
|                                                                                                                                                                   |                                                                                                       |         |                                                            |
